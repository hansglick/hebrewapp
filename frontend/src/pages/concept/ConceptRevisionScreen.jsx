...
import { getConceptRevision, conceptWebSocketUrl } from "../../api/concept";
import { mediaUrl } from "../../api/media";
import { MicrophoneIcon } from "../../components/MicrophoneIcon";
import { useWakeLock } from "../../hooks/useWakeLock";
import "../screens.css";

// Même pipeline audio que RevisionScreen/JdrScreen (cf. ces fichiers pour
// les commentaires détaillés sur chaque piège) — seule la source des
// données (item_concept_revision.json, une persona qui présente le concept
// grammatical de la leçon puis avance pas à pas) et l'URL WS changent.
...
export default function ConceptRevisionScreen() {
  ...
  async function start() {
    ...
    const ws = new WebSocket(conceptWebSocketUrl(code));
    wsRef.current = ws;
    ...
    <section className="screen">
      <div className="card card-illustration" style={{ textAlign: "center" }}>
        {/* Même gabarit que JdrScreen (image pleine largeur en tête de
            ...
            design graphique de la page conversation jeu de rôle"). */}
        <img
          className="screen-image"
          style={{ width: "100%", maxHeight: "none" }}
          src={mediaUrl(concept.image_url)}
          alt=""
          draggable={false}
        />
        ...
        {/* L'IA parle la plupart du temps en français -> justifié à gauche
            ...
            parle en hébreu — cf. demande explicite du user (RevisionScreen). */}
        <div
          style={{
            marginTop: 12,
            textAlign: "left",
